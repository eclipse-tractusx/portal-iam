...
![RolePermissions](/docs/static/05_rolesPermissions.png)
...
![TechnicalUser](/docs/static/05_technicalUser.png)
...
![RegistrationApplication](/docs/static/05_registrationApplication.png)
...
![PortalApplication](/docs/static/05_portalApplication.png)
...
![TechnicalUserAccounts](/docs/static/05_technicalUserAccounts.png)
...
![ManagedWallets](/docs/static/05_managedWallets.png)
...
![BPDMGate](/docs/static/05_bpdmGate.png)

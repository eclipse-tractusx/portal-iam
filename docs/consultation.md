...
We observed that the access tokens generated by the CX-Central realm aren't in invalidated once their expiration time has expired and if no logout is performed from the fronted application level.
